	...
	<div class="card card-outline card-primary">
        ...
        <input type="hidden" name="id" value="<?php echo isset($id) ? $id : '' ?>">
				<div class="row">
					<div class="col-md-6">
						<div class="form-group">
							<label for="" class="control-label">Konu</label>
				...
				<div class="row">
					<div class="col-md-10">
						<div class="form-group">
							<label for="" class="control-label">İçerik</label>
    	...
    	<div class="card-footer border-top border-info">
    		<div class="d-flex w-100 justify-content-center align-items-center">
    			...
    			<button class="btn btn-flat bg-gradient-secondary mx-2" type="button">İptal</button>
    		</div>
    	</div>
	</div>
</div>
