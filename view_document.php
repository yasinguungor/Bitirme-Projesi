...
$sorgu = $baglan->query("SELECT * FROM documents where md5(id) = '{$_GET['id']}' ")->fetch_array();
...
<div class="col-lg-12">
	...
	<div class="row">
		<div class="col-md-12 mb-2">
			<button class="btn bg-light border float-right" type="button" id="share"><i class="fa fa-share"></i> Dosyayı Paylaş</button>
		</div>
	</div>
    <?php endif; ?>
	<div class="row">
		...
		<div class="col-md-5">
			<div class="card card-outline card-primary">
				...
				<div class="card-body">
					<div class="col-md-12">
						<div class="alert alert-info px-2 py-1"><i class="fa fa-info-circle"></i> İndirmek için tıklayın.</div>
						<div class="row">
							 <?php
...
<script>
	...
	$('.file-item').click(function(e){
		e.preventDefault()
		_conf("Dosyayı indirmek istediğine emin misin?","dl",['"'+$(this).attr('href')+'"'])
	})
	function dl($link){
		start_load()
	...
	$('#share').click(function(){
		uni_modal("<i class='fa fa-share'></i> Link kullanarak dosyayı paylaş.","modal_share_link.php?did=<?php echo md5($id) ?>")
	})
</script>